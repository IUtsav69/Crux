...
const spec = {
  ...
  SITE_NAME: str({ example: "Crux", default: "Crux" }),
  DEFAULT_DOMAIN: str({ example: "Crux.it", default: "https://crux-backend69.vercel.app/" }),
  ...
  MAIL_FROM: str({ default: "", example: "Crux <support@Crux.it>" }),
